/*
  # Ensure all rooms have 4-digit codes
  
  1. Changes
    - Adds a trigger to ensure all rooms have exactly 4-digit room codes
    - Updates the set_room_code function to generate 4-digit codes
    - Fixes any existing rooms with invalid codes
...
-- Ensure the trigger is attached to the rooms table
