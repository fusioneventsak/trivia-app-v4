/*
  # Room Branding and Storage Configuration
  
  1. Changes
    - Create storage bucket for room logos
    - Add RLS policies for storage access (with IF NOT EXISTS checks)
    - Add functions for updating room branding
    
  2. Description
    This migration adds support for room branding including:
    - Logo storage in public bucket
