/*
  # Fix Game Sessions for Multiple Rooms
  
  1. Changes
    - Drop and recreate game_sessions table with proper structure
    - Update triggers and functions to handle multiple active rooms
    - Add proper indexes for performance
    - Fix foreign key relationships
    
  2. Description
    This migration fixes issues with game sessions to allow:
    - Multiple rooms to have their own active activations
    - Independent activation management per room
    - Proper cleanup when rooms or activations are deleted
*/
...
RETURNS TRIGGER AS $$
BEGIN
  -- Create game session if it doesn't exist for this room
